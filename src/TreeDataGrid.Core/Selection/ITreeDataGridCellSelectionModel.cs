...
namespace TreeDataGridCore.Selection
{
        ...
        where T : class
    {
        ...
        int Count { get; }
        CellIndex AnchorIndex { get; }
        CellIndex RangeAnchorIndex { get; }
        void Clear();
        ...
        /// resulting selection may not be contiguous in the data source. Column indexes refer to
        /// the source columns, including hidden columns. Negative counts extend backwards
        /// and include the starting cell; zero counts clear the selection.
        /// </remarks>
