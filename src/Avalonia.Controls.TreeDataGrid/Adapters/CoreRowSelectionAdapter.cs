...
namespace Avalonia.Controls.Adapters
{
    internal sealed class CoreRowSelectionAdapter<TModel> : ITreeDataGridRowSelectionModel<TModel>, ITreeDataGridSelectionInteraction, IDisposable where TModel : class
    {
        ...
        private event EventHandler<TreeSelectionModelSelectionChangedEventArgs>? UntypedSelectionChanged;
        ...
        {
            var args = new TreeSelectionModelSelectionChangedEventArgs<TModel>(e.DeselectedIndexes.ToAvalonia(), e.SelectedIndexes.ToAvalonia(), e.DeselectedItems, e.SelectedItems);
            SelectionChanged?.Invoke(this, args);
            UntypedSelectionChanged?.Invoke(this, args);
        }
