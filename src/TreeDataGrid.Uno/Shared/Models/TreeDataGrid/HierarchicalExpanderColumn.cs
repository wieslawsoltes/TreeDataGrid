...
namespace Avalonia.Controls.Models.TreeDataGrid
{
            ...
            where TModel : class
    {
        ...
        bool IModelExpanderState<TModel>.TryReadModelIsExpanded(TModel model, out bool isExpanded)
        {
        ...
        IObservable<BindingValue<bool>>? IModelExpanderState<TModel>.CreateModelIsExpandedObservable(TModel model)
        {
            return _isExpandedBinding?.Instance(model);
        }
