...
`TreeDataGrid.Controls.Avalonia` source-links the first project's public API, so it is not
...
- preferred package id advertised by the docs site: `TreeDataGrid.Controls.Avalonia`
