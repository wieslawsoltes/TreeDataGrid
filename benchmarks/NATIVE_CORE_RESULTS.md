# Native Core API: Avalonia 11

Measured sequentially on 2026-09-02 with BenchmarkDotNet 0.15.8, macOS ARM64, .NET 8.0.19, Release, 5 warm-ups and 10 iterations. Both API paths use the implementation committed with this report (`11.3.12.8-mvvm.2`). No second benchmark or build ran concurrently.
...
|---|---:|---:|---:|
| One-row vertical scrolling | 35.99 μs | 36.47 μs | 7.2 KB / 7.2 KB |
| Horizontal column scrolling | 205.48 μs | 206.59 μs | 168.19 KB / 168.19 KB |
| Insert/remove burst | 56.39 μs | 54.14 μs | 33.07 KB / 33.07 KB |
| Move burst | 19.56 μs | 19.17 μs | 4.23 KB / 4.23 KB |
| Detach/reattach | 846.9 μs | 863.8 μs | 724.5 KB / 728.82 KB |
| Full creation and layout | 2,147.1 μs | 2,144.2 μs | 1720.98 KB / 1709.55 KB |
