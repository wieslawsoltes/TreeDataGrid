...
namespace TreeDataGridCore.Tests
{
    public class TreeSelectionModelBaseTests_Single
    {
        ...
        public class SelectedIndex
        {
            ...
            {
                var data = new TestCollection<Node>();
                var target = CreateTarget(data);
            ...
            private class MockBinding : ICollectionChangedListener
            {
                ...
                public MockBinding(TestTreeSelectionModel target, TestCollection<Node> data)
                {
                    _target = target;
        ...
        private static TestCollection<Node> CreateNodes(IndexPath parentId, int depth = 2)
        {
            var result = new TestCollection<Node>();
        ...
        private static TestCollection<Node> CreateData(int depth = 2)
        {
            return CreateNodes(default, depth);
        }

        private static TestTreeSelectionModel CreateTarget(TestCollection<Node>? data = null)
        {
        ...
        private class Node
        {
            ...
            public TestCollection<Node>? Children { get; set; }
            public int TargetDepth { get; set; }
        }

        private class TestTreeSelectionModel : TreeSelectionModelBase<Node>
        {
            public TestTreeSelectionModel(TestCollection<Node> data)
                : base(data)
            {
            }
