...
public sealed class MetricChartCanvas : SKCanvasElement
{
    ...
    {
        // Uno draws directly into the compositor canvas. Clearing it erases
        // the panel background instead of painting a transparent chart layer.
        ...
        {
            using var typeface = SKTypeface.FromFamilyName("SF Pro Display");
    ...
    private void OnPointerMoved(object sender, PointerRoutedEventArgs e)
    {
        ...
        var x = e.GetCurrentPoint(this).Position.X - 8;
        var segment = Math.Max(1, (ActualWidth - 16) / Math.Max(Series.Samples.Length - 1, 1));
    ...
    private void DrawSeries(SKCanvas canvas, SKRect rect, SKColor accent)
    {
        ...
        using var gradient = SKShader.CreateLinearGradient(
            ...
            new SKColor[] { accent.WithAlpha(170), accent.WithAlpha(18) }, null, SKShaderTileMode.Clamp);
        ...
        var markerIndex = _hoverIndex >= 0 ? Math.Min(_hoverIndex, values.Length - 1) : values.Length - 1;
