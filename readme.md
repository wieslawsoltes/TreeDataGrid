[![NuGet Avalonia](https://img.shields.io/nuget/v/TreeDataGrid.Controls.Avalonia.svg)](https://www.nuget.org/packages/TreeDataGrid.Controls.Avalonia/)
...
Use `TreeDataGrid.Core` for ViewModel-owned sources, columns, sorting, selection and expansion without an Avalonia dependency. New views should use the `TreeDataGrid.Controls.Avalonia` package; existing `TreeDataGrid` consumers remain supported. See [migration and ownership](docs/framework-neutral-core.md).
